        ...
        <div class="row flex-grow">
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <form class="pt-3" method="post" action="registerProcess.php">
                ...
                <div class="form-group">
                  <label>If have reference a code</label>
                  <div class="input-group">
                    <div class="input-group-prepend bg-transparent">
                      <span class="input-group-text bg-transparent border-right-0">
                      </span>
                    ...
                    <?php
                    if(isset($_GET['code'])){
                      echo "<input  class=\"form-control form-control-lg border-left-0\" name='code' placeholder=\"Refference_Code\" value='".$_GET['code']."'>";
                    }else{
                      echo "<input  class=\"form-control form-control-lg border-left-0\" name='code' placeholder=\"Refference_Code\" >";
                    }
                    ?>
